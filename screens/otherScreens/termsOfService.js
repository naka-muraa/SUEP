...
5.  私は 、本サービスの提供の停止または中断により 、ユーザーまたは第三者が被ったいかなる不利益または損害についても 、一切の責任を負わないものとします。\n
 第4条（利用制限）\n
...
第13条（Twitter APIの利用）\n
 本サービスではTwitter, Inc.が提供するTwitter APIを利用し 、Twitter上のコンテンツを再配布しています。本アプリケーションを利用するユーザーはTwitterの利用規約およびプライバシーポリシーに同意しているものとみなします。
      ...
      <CustomedButton
        ...
        onPress={() =>
          openUrl(
            'https://cdn.cms-twdigitalassets.com/content/dam/legal-twitter/site-assets/privacy-policy-new/pp-tos-ja.pdf'
          )
        }
