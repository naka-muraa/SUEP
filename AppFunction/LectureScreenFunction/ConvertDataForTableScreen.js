...
export default async function ConvertDataForTableScreen(lecturesToBeDisplayedOnTable) {
  try {
    ...
    let thirdRowItem = [{ 'period': '2', 'startTime': '10:25', 'endTime': '12:05', }, {}, {}, {}, {}, {},];
    let fourthRowItem = [{ 'period': '3', 'startTime': '13:00', 'endTime': '14:40', }, {}, {}, {}, {}, {},];
    let fifthRowItem = [{ 'period': '4', 'startTime': '14:55', 'endTime': '16:35', }, {}, {}, {}, {}, {},];
    let sixthRowItem = [{ 'period': '5', 'startTime': '16:50', 'endTime': '18:30', }, {}, {}, {}, {}, {}];
    let allRowItems = [];
    let convertedData = [];
    let jsonFormatedData = [];
    const days = ['月', '火', '水', '木', '金'];
    const periods = [1, 3, 5, 7, 9];
    if (lecturesToBeDisplayedOnTable != null && lecturesToBeDisplayedOnTable != undefined) {
      ...
      allRowItems = [firstRowItem, secondRowItem, thirdRowItem, fourthRowItem, fifthRowItem, sixthRowItem];
